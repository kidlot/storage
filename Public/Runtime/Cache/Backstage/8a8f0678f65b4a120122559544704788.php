...
<html lang="en" style="overflow-y: auto;">
    ...
    <div class="main-container" id="main-container">
        <?php if(empty($user)): ?><div class="main-container">
                ...
                <div>
                    <div class="login-container">
                        <div class="center">
                            ...
                            <h4 class="blue" id="id-company-text">&copy; 阳光</h4>
                        </div>
                            ...
                            <div id="login-box" class="login-box visible widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <form id="loginForm" name="loginForm" action="<?php echo U('Login/checkLogin');?>" method="post">
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" name="account" class="form-control" placeholder="账号"  required title="账号不能为空"/>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon ">
                                                        <span class="inline"><input type="text" class="form-control" name="verify" placeholder="验证码" id="verify" required title="验证码不能为空"></span>
                                                        <img style="cursor:pointer;" src="<?php echo U('Login/verify');?>" title="看不清楚？点击刷新" onclick="this.src = '<?php echo U("Login/verify");?>?' + new Date().getTime()">
                                                    </span>
                                                </label>
    ...
    <!--[if IE]>
<script type="text/javascript">
window.jQuery || document.write("<script src='/Public/hladmin/assets/js/jquery1x.js'>"+"<"+"/script>");
</script>
<![endif]-->
    <script type="text/javascript">
        if ('ontouchstart' in document.documentElement)
            document.write("<script src='/Public/Default/aceadmin/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
    </script>
    ...
    <script type="text/javascript">
                ...
                document.getElementById('verifyImg').src = "<?php echo U('Login/verify/');?>" + "?" + Math.random();
                }
