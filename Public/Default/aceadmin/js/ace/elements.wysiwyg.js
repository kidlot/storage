...
(function($ , undefined) {
	$.fn.ace_wysiwyg = function($options , undefined) {
		...
		var color_values = [
			...
			'#c2c2c2','#cabdbf','#cca6ac','#f691b2','#cd74e6','#ffffff',
			'#000000'
		]
		...
		{
			'font' : {
				values:['Serif', 'Sans', 'Arial', 'Arial Black', 'Courier', 'Courier New', 'Comic Sans MS', 'Helvetica', 'Impact', 'Lucida Grande', 'Lucida Sans', 'Tahoma', 'Times','Times New Roman', 'Verdana'],
				icon:'fa fa-font',
				title:'字体'
			},
			'fontSize' : {
				values:{5:'5号', 4:'4号' , 3:'3号' , 2:'2号', 1:'1号'},
